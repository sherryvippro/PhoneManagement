...
namespace Admin.Controllers
{
    public class TKhachHangsController : Controller
    {
        ...
        public TKhachHangsController(QLBanDTContext context)
        {
            _context = context;
        }
        ...
        // GET: TKhachHangs/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: TKhachHangs/Create
